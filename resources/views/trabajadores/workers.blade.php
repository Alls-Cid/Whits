...
mapa = {
 ...
 mapa.map = new google.maps.Map(document.getElementById('mapa'), {
   center: {lat: 19.043556, lng: -98.198075},
   scrollwheel: false,
   zoom: 14,
   zoomControl: true,
   rotateControl : false,
 ...
 position: {lat: 19.043556, lng: -98.198075},
 draggable: true
 });
				...
				<section class="col-lg-7">
					...
					<div class="box box-solid box-default" style="height: 610px">
						...
						<div class="box-header">
							<h5>Detalle del trabajador  <label id="t3-1" hidden="">0</label>
							{{-- <button class="btn btn-success" style="float: right">Nuevo</button></h4> --}}
						</div>
						<div class="box-body">
			<form method="POST" action="/trabajadores" enctype="multipart/form-data">
								@csrf
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="text" name="nombre" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="number" name="telefono" size="10" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="text" name="correo" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="password" name="password" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									<label class="col-sm-4">Actividad: </label>
									<div class="col-sm-6">
								<div class="form-group form-horizontal">
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="text" name="descripcion" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="number" name="experiencia" class="form-control" id="t3-2" required="">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="text" name="lat" class="form-control" id="lat" required="" readonly="readonly">
									</div>
									</div>
								</div>
								...
								<div class="form-group form-horizontal">
									...
									<div class="col-sm-9">
										<div class="form-group form-horizontal">
										<input type="text" name="lng" class="form-control" id="lng" required="" readonly="readonly">
									</div>
									</div>
								</div>
